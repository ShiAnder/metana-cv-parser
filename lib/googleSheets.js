...
async function saveToSheet(data) {
  try {
    ...
    // Create a clickable download link using HYPERLINK formula
    const downloadLink = `=HYPERLINK("${cvUrl}", "Go to Download CV")`;

    // Prepare the data as a single row
    const values = [[timestamp, name, email, phone, downloadLink, content]];
